...
void ven::Renderer::recordCommandBuffer(const VkCommandBuffer commandBuffer, const uint32_t imageIndex, const VkPipeline& graphicsPipeline, const VkBuffer& vertexBuffer, const VkBuffer& indexBuffer, const VkPipelineLayout& pipelineLayout, const uint32_t indiceSize, const VkDescriptorSet* descriptorSets) const {
